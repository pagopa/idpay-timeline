...
public class TimelineConstants {
  ...
  public static final class ExceptionCode {
    ...
    public static final String TIMELINE_DETAIL_NOT_FOUND = "TIMELINE_DETAIL_NOT_FOUND";
    public static final String TIMELINE_USER_NOT_FOUND = "TIMELINE_USER_NOT_FOUND";
    public static final String TIMELINE_REFUNDS_NOT_FOUND = "TIMELINE_REFUNDS_NOT_FOUND";
    public static final String TIMELINE_GENERIC_ERROR = "TIMELINE_GENERIC_ERROR";
    public static final String TIMELINE_TOO_MANY_REQUESTS = "TIMELINE_TOO_MANY_REQUESTS";
    public static final String TIMELINE_INVALID_REQUEST = "TIMELINE_INVALID_REQUEST";
  }
